...
%.o : %.c
	...
	@printf "$(MOVE_UP)$(CLEAR_LINE)		$(BLUE)~~$(RESET) $(GREEN)Libft$(RESET) Making $(YELLOW)$@$(RESET) from $(YELLOW)$<$(RESET) $(BLUE)~~$(RESET)($MOVE_UP)"
